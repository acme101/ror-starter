...
heroku config:set SECRET_KEY_BASE=$SECRET_KEY_BASE DATABASE_HOST_PRODUCTION=$DATABASE_HOST_PRODUCTION DATABASE_PRODUCTION=$DATABASE_PRODUCTION DATABASE_USER_PRODUCTION=$DATABASE_USER_PRODUCTION DATABASE_PORT_PRODUCTION=$DATABASE_PORT_PRODUCTION DATABASE_PASSWORD_PRODUCTION=$DATABASE_PASSWORD_PRODUCTION DATABASE_URI_PRODUCTION=$DATABASE_URI_PRODUCTION -a $HEROKU_APP_NAME &> /dev/null # hide secret output
