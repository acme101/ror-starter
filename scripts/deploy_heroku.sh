...
heroku config:set SECRET_KEY_BASE=$SECRET_KEY_BASE \
  DATABASE_HOST_PRODUCTION=$HEROKU_DATABASE_HOST \
  DATABASE_PRODUCTION=$HEROKU_DATABASE \
  DATABASE_USER_PRODUCTION=$HEROKU_DATABASE_USER \
  DATABASE_PORT_PRODUCTION=$HEROKU_DATABASE_PORT \
  DATABASE_PASSWORD_PRODUCTION=$HEROKU_DATABASE_PASSWORD \
  DATABASE_URI_PRODUCTION=$HEROKU_DATABASE_URI \
