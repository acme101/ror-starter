...
heroku config:set SECRET_KEY_BASE=$SECRET_KEY_BASE \
  DATABASE_HOST=$HEROKU_DATABASE_HOST \
  DATABASE_PRODUCTION=$HEROKU_DATABASE \
  DATABASE_USER=$HEROKU_DATABASE_USER \
  DATABASE_PORT=$HEROKU_DATABASE_PORT \
  DATABASE_PASSWORD=$HEROKU_DATABASE_PASSWORD \
  DATABASE_URI=$HEROKU_DATABASE_URI \
